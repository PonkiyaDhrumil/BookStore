    ...
    <>
      <div style={{display: "flex", flexDirection: "row", justifyContent:"space-between", margin:"20px", alignItems: "center"}} >
        ...
        <div className="mr-40  space-x-1 flex">
          {!authData.id && (
            <div style={{display:"flex", flexDirection:"row", justifyContent:"center", alignItems:"center", width:"23rem"}}>
         ...
         <div style={{display: "flex", flexDirection:"row", marginRight:"20px"}}>
           {items.map((item, index) => (
            <div key={`${item.name}-${item.route}-${index}`} className="flex" style={{display: "flex", flexDirection: "row"}}>
              <Button
                variant="text"
                sx={{
                  color: "#f14d54",
